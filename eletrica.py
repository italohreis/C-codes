...
plt.plot(mf.history['loss'], 'blue', linewidth=2.0)
plt.plot(mf.history['val_loss'], 'red', linewidth=2.0)
...
plt.figure(figsize=[6,4])
plt.plot(list(range(len(saidas_estimadas))),saidas_estimadas, 'blue' , linewidth=2.0)
plt.plot (list(range(len(saidas_estimadas))),y_v, 'red', linewidth=2.0)
